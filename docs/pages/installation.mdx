...
1. **Download & install the appropriate Lightrail Core package for your operating system:**
   ...
   - *Note: Lightrail does not currently support Windows*
...
<Callout type="info" emoji="ℹ️">
  If Lightrail is not visible in the Jupyter extension search pane, close Jupyter, run `pip install --upgrade jupyterlab` in the terminal, and then follow the above instructions.   
</Callout>